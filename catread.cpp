...
int
catfrq (int molec, char *cfreq, char *buff)
{
  /*****************************************************************
...
int
catrd (int molec, int line, char *buff)
/***********************************************************************
...
char *
catdir (int molec, int *nline, double *qqln, int *iver)
/*********************************************************
...
int
getcat (char *buf, struct catdata *pdata)
{
