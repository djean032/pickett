...
void getzitot(double *zfac, int ltot, int ii, const int *lscomv,
              const int *iscomv, const int *jscomv, int alpha,
              int neqi) { /* get reduced matrix elements of nuclear spins */
...
void setzitot(
    int lv1, int lv2, int lvt, int ii,
    int neqi) { /* calculate reduced matrix elements of nuclear spins */
  /* used by getzitot */
