...
int triag (const int nm, const int nx, const int nz, double *z, double *d,
           double *e);
...
int setint (FILE *lu, /*@out@*/ BOOL *ifdiag, /*@out@*/ int *nsav,
            const int ndip, bcd_t *idip, /*@out@*/ int *isimag);
...
int setblk (FILE *lu, const int npar, bcd_t *idpar, const double *par,
            int *nblkpf, int *negy);
/************** SUBFIT interfaces ***********************************/
int getlbl (int npar, bcd_t *idpar, /*@out@*/ char *parlbl, char *fil,
            int idiv, int len);
int getblk (/*@out@*/ int *iblk, /*@out@*/ int *indx, short *iqnum, int nblkpf,
            int ipos, int nqn);
...
int frqdat (int line, /*@out@*/ int *ibln, /*@out@*/ double *xfrq,
            /*@out@*/ double *xwt, /*@out@*/ double *xerr,
            /*@out@*/ short *iqn);
