...
int
lsqfit (double *dk, int ndm, int nr, int nvec, double *marqp, double *varv,
...
int
jelim (double *t, double *vec, int ndm, int n, int ns)
...
int
dqrfac (double *t, int ndm, int m, int n, int ns, double *wk, int *iperm)
{
...
int
dqrsolv (double *t, int ndm, int nrank, int n, int ns, int *iperm)
{
...
int
lmpar (int nr, int nc, int ns, double *r, int ldr, double *x, double *par,
       double *wk)
